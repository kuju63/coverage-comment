...
const CoberturaParser_1 = __nccwpck_require__(266);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (totalModuleCount > 0) {
                core.debug(`Total line covered ${(totalLineRate / totalModuleCount) * 100}`);
                core.debug(`Total branch covered ${(totalBranchRate / totalModuleCount) * 100}`);
            }
            else {
...
function guardCoverageType(type) {
...
const fast_xml_parser_1 = __importDefault(__nccwpck_require__(729));
const core = __importStar(__nccwpck_require__(186));
...
class CoberturaParser {
    parse(path) {
        ...
        const coverageXml = fast_xml_parser_1.default.parse(fs_1.default.readFileSync(path).toString('utf-8'), {
...
const buildOptions = __nccwpck_require__(280).buildOptions;
...
const x2j = __nccwpck_require__(712);
const buildOptions = __nccwpck_require__(280).buildOptions;
...
const nodeToJson = __nccwpck_require__(270);
const xmlToNodeobj = __nccwpck_require__(712);
const x2xmlnode = __nccwpck_require__(712);
const buildOptions = __nccwpck_require__(280).buildOptions;
...
exports.convertTonimn = __nccwpck_require__(901).convert2nimn;
exports.getTraversalObj = xmlToNodeobj.getTraversalObj;
exports.convertToJson = nodeToJson.convertToJson;
exports.convertToJsonString = __nccwpck_require__(14).convertToJsonString;
exports.validate = validator.validate;
exports.j2xParser = __nccwpck_require__(152);
...
const util = __nccwpck_require__(280);
const buildOptions = __nccwpck_require__(280).buildOptions;
const xmlNode = __nccwpck_require__(539);
const regx =
